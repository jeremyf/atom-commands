...
module.exports = {
  ...
  activate () {
    ...
    this.subscriptions.add(
      atom.commands.add('atom-workspace', {'takeonrules-commands:wrapAbbr': () => this.wrapAbbr()}),
      atom.commands.add('atom-workspace', {'takeonrules-commands:wrapUpdate': () => this.wrapUpdate()})
    );
  },
